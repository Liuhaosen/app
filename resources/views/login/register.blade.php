...
<html>
	<head>
		...
		<!-- Basic -->
		<meta charset="utf-8">
		<title>@section('title')注册@show</title>		
		...
		<!-- Vendor CSS -->
		<link rel="stylesheet" href="/f/vendor/bootstrap/bootstrap.css">
		<link rel="stylesheet" href="/f/vendor/fontawesome/css/font-awesome.css">
		<link rel="stylesheet" href="/f/vendor/owlcarousel/owl.carousel.css" media="screen">
		<link rel="stylesheet" href="/f/vendor/owlcarousel/owl.theme.css" media="screen">
		<link rel="stylesheet" href="/f/vendor/magnific-popup/magnific-popup.css" media="screen">

		<!-- Theme CSS -->
		<link rel="stylesheet" href="/f/css/theme.css">
		<link rel="stylesheet" href="/f/css/theme-elements.css">
		<link rel="stylesheet" href="/f/css/theme-blog.css">
		<link rel="stylesheet" href="/f/css/theme-shop.css">
		<link rel="stylesheet" href="/f/css/theme-animate.css">

		<!-- Skin CSS -->
		<link rel="stylesheet" href="/f/css/skins/default.css">

		<!-- Theme Custom CSS -->
		<link rel="stylesheet" href="/f/css/custom.css">

		<!-- Head Libs -->
		<script src="/f/vendor/modernizr/modernizr.js"></script>
	...
	<body>
		...
		@section('header')
			<header id="header">
				<div class="container">
					<h1 class="logo">
						<a href="index.html">
							<img alt="Porto" width="111" height="54" data-sticky-width="82" data-sticky-height="40" src="/f/img/logo.png">
						</a>
					</h1>
					<div class="search">
						...
						<div class="row">
							<div class="col-md-1">
								<a href="index.html" class="logo">
									<img alt="Porto Website Template" class="img-responsive" src="/f/img/logo-footer.png">
								</a>
							</div>
							<div class="col-md-7">
		...
		<!-- Vendor -->
		<script src="/f/vendor/jquery/jquery.js"></script>
		<script src="/f/vendor/jquery.appear/jquery.appear.js"></script>
		<script src="/f/vendor/jquery.easing/jquery.easing.js"></script>
		<script src="/f/vendor/jquery-cookie/jquery-cookie.js"></script>
		<script src="/f/vendor/bootstrap/bootstrap.js"></script>
		<script src="/f/vendor/common/common.js"></script>
		<script src="/f/vendor/jquery.validation/jquery.validation.js"></script>
		<script src="/f/vendor/jquery.stellar/jquery.stellar.js"></script>
		<script src="/f/vendor/jquery.easy-pie-chart/jquery.easy-pie-chart.js"></script>
		<script src="/f/vendor/jquery.gmap/jquery.gmap.js"></script>
		<script src="/f/vendor/twitterjs/twitter.js"></script>
		<script src="/f/vendor/isotope/jquery.isotope.js"></script>
		<script src="/f/vendor/owlcarousel/owl.carousel.js"></script>
		<script src="/f/vendor/jflickrfeed/jflickrfeed.js"></script>
		<script src="/f/vendor/magnific-popup/jquery.magnific-popup.js"></script>
		<script src="/f/vendor/vide/vide.js"></script>
		
		<!-- Theme Base, Components and Settings -->
		<script src="/f/js/theme.js"></script>
		
		<!-- Theme Custom -->
		<script src="/f/js/custom.js"></script>
		
		<!-- Theme Initialization Files -->
		<script src="/f/js/theme.init.js"></script>
