...
<script type="text/javascript" charset="utf-8" src="/b/ueditor/lang/zh-cn/zh-cn.js"></script>
  ...
  <div class="mws-panel grid_8">
     ...
     <div class="mws-panel-body no-padding"> 
          <form action="{{url('admin/article/update')}}" method="post"  enctype="multipart/form-data" class="mws-form">
           @if (count($errors) > 0)
               ...
               <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                       <label class="mws-form-label">文章描述</label>
                          <div class="mws-form-item">
                            <textarea rows="" cols="" value = "{{$article->descr}}" class="small" name="descr">{{$article->descr}}</textarea>
                         </div>
                   </div>
                   <div class="mws-form-row">
